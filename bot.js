...
client.on('message', msg => {  
  ...
  client.on('message', msg => {  
    if (msg.content === 'F1') { 
      msg.reply('** :wink: ← #«الــشــات-الــعـــام»  يمكنك التواصل والتحدث مع الناس والمشرفين ومصطفى الشمري .

←  #⚡فعاليات⚡  يمكنك لعب العاب وربح جوائز قيمه مع القائمين او المشرفين ، tada.

← #«videos-الــفــيــديــوهــات»  يمكنك رؤية مقاطع  اليوتيوبرز  في السيرفر .

← #«news-الاخبـــــــــار»  يمكنك رؤيه كل االأخبار المتعلقة بالسيرفر  .

←  #«العاب-بوت»  يمكنك لعب العاب متنوعه مع الروبوت (( البوت )) robot .

← #«commands-الاوامــر» يمكنك رؤيه مستوى تفاعلك وكسب الالوان او رتب sparkles

← #«laws-القــــــــوانين»  يمكنك قراءة قوانين السيرفر  .

←  #«pictures-الصــــــــور» يمكنك قراءة ونشر نكت مع رؤية خواطر ونشر رسائل بشكل متكرر ونشر صور .

إذا كان لديك سؤال آخر لا تترد بطرحه علينا ، وشكراً :sparkling_heart:**'); 
    }
  });
